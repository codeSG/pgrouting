...
#include "drivers/codesgDijkstra/codesgDijkstra_driver.h"  // the link to the C++ code of the function

PGDLLEXPORT Datum codesgDijkstra(PG_FUNCTION_ARGS);
PG_FUNCTION_INFO_V1(codesgDijkstra);
...
process(
    ...
    time_msg(" processing pgr_codesgDijkstra", start_t, clock());
