...
#include "drivers/dummyDijkstra/dummyDijkstra_driver.h"  // the link to the C++ code of the function

PGDLLEXPORT Datum dummyDijkstra(PG_FUNCTION_ARGS);
PG_FUNCTION_INFO_V1(dummyDijkstra);
...
process(
    ...
    time_msg(" processing pgr_dummyDijkstra", start_t, clock());
